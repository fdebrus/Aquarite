...
def main():
    ...
    parser.add_argument('-a', action='append', nargs=2, dest='aux', choices=['0','1','2','3'], help='set aux relay status to 0:OFF or 1:ON')
    ...
    parser.add_argument('-d', action='store', dest='pumpDuration', default='1380', help='set intelligent mode minimum filtration time') # 1380 = 24HRS, how ?
    parser.add_argument('-i', action='store', dest='pumpInterval', default='"inter1":"07:00-22:00","inter2":"00:00-00:00","inter3":"00:00-00:00"', help='set interval for filtration')
    ...
    if args.refresh:
        ...
        if (pumpType == '2'):
            ...
            print(params)
        if (pumpType == '3'):
            params = '&data={"type":'+pumpType+',"tempMin":20,"tempMax":'+options.pumpTemp+',"freeze":'+options.pumpFreeze+'}&int={'+options.pumpInterval+'}&vel='
            print(params)
        if (pumpType == '4'):
